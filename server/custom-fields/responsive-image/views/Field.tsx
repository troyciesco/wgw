...
export function Field({ autoFocus, field, value, onChange }: FieldProps<typeof import(".").controller>) {
...
export const ImageMeta = ({ width = 0, height = 0, size }: { width?: number; height?: number; size: number }) => {
  return (
    <Stack
      padding="xxsmall"
      gap="xxsmall">
