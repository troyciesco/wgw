<script lang="ts">
  ...
  export let site: any
  $: src = getImage(site.landscapeImage, 2)
</script>

<div class="bg-white dark:bg-slate-700 h-full shadow-md rounded-lg w-[28rem] group relative">
  {#if $page.data.user}
    <div
  ...
  <a href={`/sites/${site.slug}`}>
    <div class="relative w-[28rem] h-[21rem] rounded-lg overflow-hidden">
      <img
